...
public class RichiestaDAOImpl implements RichiestaDAO {
    ...
    public RichiestaDAOImpl() {
        connection = ConnectionManager.getConnection();
    }

    // Implementazione dei metodi specifici per Richiesta
    @Override
    public List<LibreriaUtente> getAllRichiesteLibreria(int codUtente) {
        ...
        // Implementazione per ottenere tutte le richieste della libreria dell'utente
    }
    ...
    public List<Richiesta> getAllRichieste(int codUtente) {
        ...
        return richieste;
        // Implementazione per ottenere tutte le richieste dell'utente
    }
    ...
    public void insertRichiesta(int codUtente, int codTesto) {
        ...
        // Implementazione per l'inserimento di una richiesta
    }
    ...
    public void deleteRichiesta(int codRichiesta) {
        ...
        // Implementazione per eliminare una richiesta
    }

    @Override
    public void updateRichiestaStatus() {
        // Implementazione per aggiornare lo stato delle richieste
